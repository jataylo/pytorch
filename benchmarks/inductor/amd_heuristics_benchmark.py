...
def test_vgpr_limits_device_derived() -> None:
    ...
    try:
        from torch._inductor.codegen.triton_heuristics_arch import get_architecture_config
...
def test_architecture_config_fields() -> None:
    ...
    try:
        from torch._inductor.codegen.triton_heuristics_arch import get_architecture_config, ArchitectureConfig
