...
enum TORCH_HIP_CPP_API TuningStatus {
  OK = 0,
  FAIL = 1,
  UNSUPPORTED = 2,
};
...
class TORCH_HIP_CPP_API ResultEntry {
  public:
...
struct TORCH_HIP_CPP_API TuningResults {
...
class TORCH_HIP_CPP_API TuningResultsManager {
  public:
...
class TORCH_HIP_CPP_API TuningResultsValidator {
  public:
...
class TORCH_HIP_CPP_API TuningContext {
  public:
    TuningContext();
    ~TuningContext();
...
TORCH_HIP_CPP_API TuningContext* getTuningContext();
