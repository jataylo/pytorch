...
struct GemmParams : OpParams {
  ...
  GemmParams* DeepCopy(bool duplicate_inputs) const {
    ...
    *copy = *this;
    ...
    copy->c = static_cast<T*>(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(c_size));
    AT_CUDA_CHECK(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::memcpyAsync(
        copy->c, device, c, device, c_size, getCurrentHIPStreamMasqueradingAsCUDA(device), true));
    if (duplicate_inputs) {
      size_t a_size = GetSizeA();
      size_t b_size = GetSizeB();
      copy->a = static_cast<const T*>(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(a_size));
      copy->b = static_cast<const T*>(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(b_size));
  ...
  void Delete() {
    c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_delete(c);
    if (duplicate_inputs_) {
      // NOLINTNEXTLINE(*const-cast*)
      c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_delete(const_cast<T*>(a));
      // NOLINTNEXTLINE(*const-cast*)
      c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_delete(const_cast<T*>(b));
    }
  }
...
struct GemmStridedBatchedParams : OpParams {
  ...
  GemmStridedBatchedParams* DeepCopy(bool duplicate_inputs) const {
    ...
    *copy = *this;
    ...
    AT_CUDA_CHECK(c10::hip::GetDevice(&device));
    size_t c_size = GetSizeC();
    copy->c = static_cast<C_Dtype*>(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(c_size));
    AT_CUDA_CHECK(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::memcpyAsync(
        copy->c, device, c, device, c_size, getCurrentHIPStreamMasqueradingAsCUDA(device), true));
    if (duplicate_inputs) {
      size_t a_size = GetSizeA();
...
struct ScaledGemmParams : OpParams {
  ...
  ScaledGemmParams* DeepCopy(bool duplicate_inputs) const {
    ...
    *copy = *this;
    ...
    AT_CUDA_CHECK(c10::hip::GetDevice(&device));
    size_t c_size = GetSizeC();
    copy->c = c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(c_size);
    AT_CUDA_CHECK(c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::memcpyAsync(
        copy->c, device, c, device, c_size, getCurrentHIPStreamMasqueradingAsCUDA(device), true));
    if (duplicate_inputs) {
      size_t a_size = GetSizeA();
      size_t b_size = GetSizeB();
      copy->a = c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(a_size);
      copy->b = c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_alloc(b_size);
      copy->duplicate_inputs_ = true;
    }
    return copy;
  }
  ...
  void Delete() {
    ...
    if (duplicate_inputs_) {
      // NOLINTNEXTLINE(*const-cast*)
      c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_delete(const_cast<void*>(a));
      // NOLINTNEXTLINE(*const-cast*)
      c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::raw_delete(const_cast<void*>(b));
    }
  }
