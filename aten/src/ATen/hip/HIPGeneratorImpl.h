 ...
 *   hiprand_init(std::get<0>(seeds), // seed
...
struct TORCH_HIP_CPP_API CUDAGeneratorImpl : public c10::GeneratorImpl {
  // Constructors
...
TORCH_HIP_CPP_API const Generator& getDefaultCUDAGenerator(
    DeviceIndex device_index = -1);
TORCH_HIP_CPP_API Generator createCUDAGenerator(DeviceIndex device_index = -1);
