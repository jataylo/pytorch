...
inline TORCH_HIP_CPP_API at::HostAllocator* getCachingHostAllocator() {
...
inline TORCH_HIP_CPP_API bool CachingHostAllocator_recordEvent(
    void* ptr,
    void* ctx,
    c10::hip::HIPStreamMasqueradingAsCUDA stream) {
...
inline TORCH_HIP_CPP_API void CachingHostAllocator_emptyCache() {
...
inline TORCH_HIP_CPP_API at::DataPtr HostAlloc(size_t size) {
...
inline TORCH_HIP_CPP_API at::HostStats CachingHostAllocator_getStats() {
...
inline TORCH_HIP_CPP_API void CachingHostAllocator_resetAccumulatedStats() {
...
inline TORCH_HIP_CPP_API void CachingHostAllocator_resetPeakStats() {
