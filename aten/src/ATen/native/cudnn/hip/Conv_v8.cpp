...
void run_conv_plan(
  ...
  auto workspace_ptr =
      c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::get()->allocate(workspace_size);
  void* data_ptrs[3];
...
void generate_and_filter_plans(
  ...
  while (max_workspace_size) {
    try {
      workspace_ptr =
          c10::hip::HIPCachingAllocatorMasqueradingAsCUDA::get()->allocate(max_workspace_size);
      break;
