...
void _csrmm2(
  ...
  hipDataType cusparse_value_type)
{
  ...
  TORCH_CUDASPARSE_CHECK(hipsparseCreateCsr(
    ...
    HIPSPARSE_INDEX_BASE_ZERO,   /* base index of row offset and col index */
  ...
  auto default_alg = prop->major == 8 && prop->minor == 9 ? HIPSPARSE_SPMM_CSR_ALG2 : HIPSPARSE_CSRMM_ALG1;
#else
