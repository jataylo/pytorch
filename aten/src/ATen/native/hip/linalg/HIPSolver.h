...
template<class Dtype>
hipDataType get_cusolver_datatype() {
  static_assert(false&&sizeof(Dtype), "cusolver doesn't support data type");
  return {};
}
template<> hipDataType get_cusolver_datatype<float>();
template<> hipDataType get_cusolver_datatype<double>();
template<> hipDataType get_cusolver_datatype<c10::complex<float>>();
template<> hipDataType get_cusolver_datatype<c10::complex<double>>();
...
hipsolverDnHandle_t handle, hipsolverDnParams_t params,                         \
hipsolverEigMode_t jobvl, hipsolverEigMode_t jobvr, int64_t n,                  \
...
hipsolverDnHandle_t handle, hipsolverDnParams_t params,                          \
hipsolverEigMode_t jobvl, hipsolverEigMode_t jobvr, int64_t n, scalar_t *A,      \
