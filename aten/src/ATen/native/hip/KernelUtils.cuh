...
__device__ __forceinline__ void fastSpecializedAtomicAdd(
  ...
  bool low_byte = (reinterpret_cast<std::uintptr_t>(target_addr) % sizeof(__hip_bfloat162) == 0);
...
#else
    atomicAdd(
        reinterpret_cast<__hip_bfloat16*>(tensor) + index, *reinterpret_cast<__hip_bfloat16*>(&value));
#endif
  }
#endif
}
