...
#include <ATen/hip/HIPScaledBlas.h>
#include <ATen/hip/tunable/Tunable.h>
#include <ATen/hip/tunable/TunableGemm.h>
#include <ATen/native/Resize.h>
#include <c10/util/MaybeOwned.h>
#include <ATen/native/GroupedMMUtils.h>
#include <ATen/native/hip/cuBlasCommonArgs.h>
#include <ATen/native/hip/RowwiseScaledMM.h>
#include <ATen/native/hip/ScaledGroupMM.h>
#include <ATen/native/hip/GroupMM.h>
...
static bool isInputCompliesAddmmCudaLt(
  ...
  return (beta.toComplexDouble() == 1.0
    ...
    && ( // some shape/stride restrictions
      ...
      // HIPBLAS_STATUS_INVALID_VALUE error from hipblasLtMatmulAlgoGetHeuristic.
      ...
      #if !(defined(TORCH_HIP_VERSION) && TORCH_HIP_VERSION >= 12010 || defined(USE_ROCM))
...
Tensor& _int_mm_out_cuda(const Tensor& self, const Tensor& mat2, Tensor& result) {
  ...
  TORCH_CHECK(false, "_int_mm_out_cuda not compiled for CUDA ", TORCH_HIP_VERSION);
#else
