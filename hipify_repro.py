...
static hipFunction_t triton_poi_fused_sigmoid_0 = nullptr;
...
std::vector<at::Tensor> inductor_entry_cpp(const std::vector<at::Tensor>& args) {
    ...
    hipDeviceptr_t var_0 = reinterpret_cast<hipDeviceptr_t>(buf1.data_ptr());
    int var_1 = 32;
...
module = load_inline(
    ...
    extra_ldflags=['-shared -fPIC -L/var/lib/jenkins/pytorch/torch/lib -L/opt/rocm/lib -L/opt/rocm/hip/lib -L/opt/conda/envs/py_3.9/lib -lc10 -ltorch -ltorch_cpu -ltorch_python -lgomp'],
