...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/5v/c5v7sjrpwcv4hie2jpqbr5j56mnn6p6mkwl4cx66kwhdttkxdmzf.py
...
#   sqrt => sqrt
# Graph fragment:
#   %arg1_1 : Tensor "f32[s24][1]cuda:0" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "f32[s24][1]cuda:0" = PlaceHolder[target=arg2_1]
#   %arg3_1 : Tensor "f32[s24][1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg4_1 : Tensor "f32[s24][1]cuda:0" = PlaceHolder[target=arg4_1]
#   %relu : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%arg1_1,), kwargs = {})
#   %sigmoid : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%arg2_1,), kwargs = {})
#   %mul_7 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%relu, %sigmoid), kwargs = {})
#   %tanh : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.tanh.default](args = (%arg3_1,), kwargs = {})
#   %mul_3 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg4_1, 0.5), kwargs = {})
#   %mul_4 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg4_1, 0.7071067811865476), kwargs = {})
#   %erf : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_4,), kwargs = {})
#   %add_6 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf, 1), kwargs = {})
#   %mul_5 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_3, %add_6), kwargs = {})
#   %mul_9 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, %mul_5), kwargs = {})
#   %add_13 : Tensor "f32[s24][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_7, %mul_9), kwargs = {})
#   %abs_1 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%add_13,), kwargs = {})
#   %abs_2 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%add_13,), kwargs = {})
#   %add_20 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%abs_2, 1e-06), kwargs = {})
#   %sqrt : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%add_20,), kwargs = {})
#   %add_25 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%abs_1, %sqrt), kwargs = {})
#   %sin : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sin.default](args = (%add_25,), kwargs = {})
#   %cos : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cos.default](args = (%add_13,), kwargs = {})
#   %mul_19 : Tensor "f32[s24][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sin, %cos), kwargs = {})
#   %abs_3 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%mul_19,), kwargs = {})
#   %neg : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%abs_3,), kwargs = {})
#   %exp : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%neg,), kwargs = {})
#   %add_40 : Tensor "f32[s24][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_19, %exp), kwargs = {})
#   return %add_40
...
def get_args():
    ...
    return arg_0, arg_1, arg_2, arg_3, arg_4, 1048576,
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/f4/cf4chni3cnb77mskdz4i76sscppyw3ltity5bq2pbhiibhumssc3.py
...
#   %exp : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%neg,), kwargs = {})
#   %add_40 : Tensor "f32[s24][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_19, %exp), kwargs = {})
#   %mean : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.default](args = (%add_40,), kwargs = {})
#   return %buf1
...
def triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ks0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK, num_stages = 2):
        ...
        tmp7 = tl.load(in_ptr1 + (r0_1 + x0*((127 + ks0) // 128)), r0_mask & tmp3 & xmask, eviction_policy='evict_first', other=0.0)
        tmp8 = tl.sigmoid(tmp7)
        tmp9 = tmp6 * tmp8
        tmp10 = tl.load(in_ptr2 + (r0_1 + x0*((127 + ks0) // 128)), r0_mask & tmp3 & xmask, eviction_policy='evict_first', other=0.0)
        tmp11 = libdevice.tanh(tmp10)
        tmp12 = tl.load(in_ptr3 + (r0_1 + x0*((127 + ks0) // 128)), r0_mask & tmp3 & xmask, eviction_policy='evict_first', other=0.0)
        tmp13 = 0.5
        tmp14 = tmp12 * tmp13
...
def get_args():
    ...
    arg_5 = 1048576
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, 128, 8192,
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/23/c23efu5xr2o6v63m66kufs67elcjw3fmmlnlpnpk5ijn2mx4z4kx.py
# Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean]
# Source node to ATen node mapping:
#   a => relu
#   abs_2 => abs_2
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/ff/cffbty4z4qlvrfop324qghidjllkfrmpmffshlxzo55fz6qjj3ze.py
# Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
# Source node to ATen node mapping:
#   std => var
# Graph fragment:
#   %add_40 : Tensor "f32[s24][1]cuda:0" = PlaceHolder[target=add_40]
#   %var : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%add_40,), kwargs = {correction: 1.0})
...
@triton.jit
def triton_red_fused_std_3(in_ptr0, out_ptr0, out_ptr1, out_ptr2, ks0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 128
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
    xoffset = tl.program_id(0) * XBLOCK
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/kw/ckw6lllmfsiajrhvxolj7rirg3wi46ckhpcjaz7rbz4wz7zqpoqb.py
# Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
# Source node to ATen node mapping:
#   std => var
# Graph fragment:
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/y7/cy7hx7y5kstozoqvgcq4zv27uxvqyes4bje44shf4tb3wtjyizas.py
...
#   %add_40 : Tensor "f32[s24][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_19, %exp), kwargs = {})
#   %mean : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.default](args = (%add_40,), kwargs = {})
#   %sub_19 : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_40, %mean), kwargs = {})
#   %var : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%add_40,), kwargs = {correction: 1.0})
#   %sqrt_1 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%var,), kwargs = {})
#   %add_45 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sqrt_1, 1e-06), kwargs = {})
#   %div : Tensor "f32[s24][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sub_19, %add_45), kwargs = {})
#   return %div
...
@triton.jit
def triton_poi_fused_abs_add_cos_div_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_std_sub_tanh_5(in_out_ptr0, in_ptr0, in_ptr1, ks0, xnumel, XBLOCK : tl.constexpr):
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
    x0 = xindex
...
class Runner:
    ...
    def call(self, args):
        ...
        s24 = arg1_1_size[0]
        assert_size_stride(arg1_1, (s24, ), (1, ))
        assert_size_stride(arg2_1, (s24, ), (1, ))
        assert_size_stride(arg3_1, (s24, ), (1, ))
        assert_size_stride(arg4_1, (s24, ), (1, ))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf0 = empty_strided_cuda((s24, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp]
            stream0 = get_raw_stream(0)
            triton_poi_fused_abs_add_cos_exp_gelu_mul_neg_relu_sigmoid_sin_sqrt_tanh_0.run(arg1_1, arg2_1, arg3_1, arg4_1, buf0, s24, stream=stream0)
            buf1 = empty_strided_cuda((128, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean]
            triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1_r0_numel = (127 + s24) // 128
            stream0 = get_raw_stream(0)
            triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1.run(arg1_1, arg2_1, arg3_1, arg4_1, buf1, s24, 128, triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1_r0_numel, stream=stream0)
            del arg1_1
            del arg2_1
            del arg3_1
            del arg4_1
            ...
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_2.run(buf1, buf2, 1, 128, stream=stream0)
            buf3 = buf1; del buf1  # reuse
            buf4 = empty_strided_cuda((128, ), (1, ), torch.float32)
            buf5 = empty_strided_cuda((128, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
            triton_red_fused_std_3_r0_numel = (127 + s24) // 128
            stream0 = get_raw_stream(0)
            triton_red_fused_std_3.run(buf0, buf3, buf4, buf5, s24, 128, triton_red_fused_std_3_r0_numel, stream=stream0)
            buf7 = empty_strided_cuda((), (), torch.float32)
            # Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
            stream0 = get_raw_stream(0)
            triton_per_fused_std_4.run(buf3, buf4, buf5, buf7, 1, 128, stream=stream0)
            del buf3
            del buf4
            del buf5
            ...
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean, sub, std, add_4, result], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean, aten.sub, aten.std, aten.div]
            stream0 = get_raw_stream(0)
            triton_poi_fused_abs_add_cos_div_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_std_sub_tanh_5.run(buf9, buf2, buf7, s24, s24, stream=stream0)
            del buf2
            del buf7
        return (buf9, )
