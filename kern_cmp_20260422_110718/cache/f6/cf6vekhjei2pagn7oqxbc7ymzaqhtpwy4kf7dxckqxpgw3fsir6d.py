...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/rt/crtvplkdk6yuoyskfrers3l34cucroowvnvkiijl45u2eijtp3jo.py
...
#   sqrt => sqrt
# Graph fragment:
#   %arg2_1 : Tensor "f32[s24, s0][s0, 1]cuda:0" = PlaceHolder[target=arg2_1]
#   %arg3_1 : Tensor "f32[s24, s0][s0, 1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg4_1 : Tensor "f32[s24, s0][s0, 1]cuda:0" = PlaceHolder[target=arg4_1]
#   %arg5_1 : Tensor "f32[s24, s0][s0, 1]cuda:0" = PlaceHolder[target=arg5_1]
#   %relu : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%arg2_1,), kwargs = {})
#   %sigmoid : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%arg3_1,), kwargs = {})
#   %mul_11 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%relu, %sigmoid), kwargs = {})
#   %tanh : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.tanh.default](args = (%arg4_1,), kwargs = {})
#   %mul_6 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg5_1, 0.5), kwargs = {})
#   %mul_7 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg5_1, 0.7071067811865476), kwargs = {})
#   %erf : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_7,), kwargs = {})
#   %add_9 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf, 1), kwargs = {})
#   %mul_8 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %add_9), kwargs = {})
#   %mul_14 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, %mul_8), kwargs = {})
#   %add_19 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %mul_14), kwargs = {})
#   %abs_1 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%add_19,), kwargs = {})
#   %abs_2 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%add_19,), kwargs = {})
#   %add_29 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%abs_2, 1e-06), kwargs = {})
#   %sqrt : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%add_29,), kwargs = {})
#   %add_36 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%abs_1, %sqrt), kwargs = {})
#   %sin : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sin.default](args = (%add_36,), kwargs = {})
#   %cos : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cos.default](args = (%add_19,), kwargs = {})
#   %mul_33 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sin, %cos), kwargs = {})
#   %abs_3 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%mul_33,), kwargs = {})
#   %neg : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%abs_3,), kwargs = {})
#   %exp : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%neg,), kwargs = {})
#   %add_58 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_33, %exp), kwargs = {})
#   return %add_58
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/bd/cbd7bktknzjhz4vc7fphufvq4b64wniscjlgksrv33cfdjol3vqg.py
...
#   %exp : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%neg,), kwargs = {})
#   %add_58 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_33, %exp), kwargs = {})
#   %mean : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.default](args = (%add_58,), kwargs = {})
#   return %buf1
...
def triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, ks0, ks1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK, num_stages = 2):
        ...
        tmp7 = tl.load(in_ptr1 + (((r0_1 + x0*((31 + ks0*ks1) // 32)) % (ks0*ks1))), r0_mask & tmp3 & xmask, eviction_policy='evict_last', other=0.0)
        tmp8 = tl.sigmoid(tmp7)
        tmp9 = tmp6 * tmp8
        tmp10 = tl.load(in_ptr2 + (((r0_1 + x0*((31 + ks0*ks1) // 32)) % (ks0*ks1))), r0_mask & tmp3 & xmask, eviction_policy='evict_last', other=0.0)
        tmp11 = libdevice.tanh(tmp10)
        tmp12 = tl.load(in_ptr3 + (((r0_1 + x0*((31 + ks0*ks1) // 32)) % (ks0*ks1))), r0_mask & tmp3 & xmask, eviction_policy='evict_last', other=0.0)
        tmp13 = 0.5
        tmp14 = tmp12 * tmp13
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/rx/crxcpgxfw4jgqlc5z7ybx3k36rx6pssm7sark2yhvegc6ghlmpry.py
# Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean]
# Source node to ATen node mapping:
#   a => relu
#   abs_2 => abs_2
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/xh/cxherksn6xfu3iebcscy7ppshhrlfofmfjcwy3vda3t4kvm6qucn.py
# Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
# Source node to ATen node mapping:
#   std => var
# Graph fragment:
#   %add_58 : Tensor "f32[s24, s0][s0, 1]cuda:0" = PlaceHolder[target=add_58]
#   %var : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%add_58,), kwargs = {correction: 1.0})
...
@triton.jit
def triton_red_fused_std_3(in_ptr0, out_ptr0, out_ptr1, out_ptr2, ks0, ks1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    xnumel = 32
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
    xoffset = tl.program_id(0) * XBLOCK
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/af/cafyw7fpw72v3dt7ve23csdknctfsdqrkrxoublwasyzjsnb2hj4.py
# Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
# Source node to ATen node mapping:
#   std => var
# Graph fragment:
#   %buf3 : Tensor "f32[32][1]cuda:0" = PlaceHolder[target=buf3]
#   %buf4 : Tensor "f32[32][1]cuda:0" = PlaceHolder[target=buf4]
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/7s/c7sd5ztpuerkgeh2svyemq33ezs45epjajkz3bzn2nuivkrcz5a6.py
...
#   %add_58 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_33, %exp), kwargs = {})
#   %mean : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.default](args = (%add_58,), kwargs = {})
#   %sub_38 : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_58, %mean), kwargs = {})
#   %var : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%add_58,), kwargs = {correction: 1.0})
#   %sqrt_1 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%var,), kwargs = {})
#   %add_65 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sqrt_1, 1e-06), kwargs = {})
#   %div : Tensor "f32[s24, s0][s0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sub_38, %add_65), kwargs = {})
#   return %div
...
@triton.jit
def triton_poi_fused_abs_add_cos_div_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_std_sub_tanh_5(in_out_ptr0, in_ptr0, in_ptr1, ks0, ks1, xnumel, XBLOCK : tl.constexpr):
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
    x0 = xindex
...
class Runner:
    ...
    def call(self, args):
        ...
        s24 = arg2_1_size[0]
        assert_size_stride(arg2_1, (s24, s0), (s0, 1))
        assert_size_stride(arg3_1, (s24, s0), (s0, 1))
        assert_size_stride(arg4_1, (s24, s0), (s0, 1))
        assert_size_stride(arg5_1, (s24, s0), (s0, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf0 = empty_strided_cuda((s24, s0), (s0, 1), torch.float32)
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp]
            triton_poi_fused_abs_add_cos_exp_gelu_mul_neg_relu_sigmoid_sin_sqrt_tanh_0_xnumel = s0*s24
            stream0 = get_raw_stream(0)
            triton_poi_fused_abs_add_cos_exp_gelu_mul_neg_relu_sigmoid_sin_sqrt_tanh_0.run(arg2_1, arg3_1, arg4_1, arg5_1, buf0, triton_poi_fused_abs_add_cos_exp_gelu_mul_neg_relu_sigmoid_sin_sqrt_tanh_0_xnumel, stream=stream0)
            buf1 = empty_strided_cuda((32, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean]
            triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1_r0_numel = (31 + s0*s24) // 32
            stream0 = get_raw_stream(0)
            triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1.run(arg2_1, arg3_1, arg4_1, arg5_1, buf1, s0, s24, 32, triton_red_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_1_r0_numel, stream=stream0)
            del arg2_1
            del arg3_1
            del arg4_1
            del arg5_1
            ...
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused_abs_add_cos_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_tanh_2.run(buf1, buf2, 1, 32, stream=stream0)
            buf3 = buf1; del buf1  # reuse
            buf4 = empty_strided_cuda((32, ), (1, ), torch.float32)
            buf5 = empty_strided_cuda((32, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
            triton_red_fused_std_3_r0_numel = (31 + s0*s24) // 32
            stream0 = get_raw_stream(0)
            triton_red_fused_std_3.run(buf0, buf3, buf4, buf5, s0, s24, 32, triton_red_fused_std_3_r0_numel, stream=stream0)
            buf7 = empty_strided_cuda((), (), torch.float32)
            # Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
            stream0 = get_raw_stream(0)
            triton_per_fused_std_4.run(buf3, buf4, buf5, buf7, 1, 32, stream=stream0)
            del buf3
            del buf4
            del buf5
            buf9 = buf0; del buf0  # reuse
            # Topologically Sorted Source Nodes: [a, b, mul, c, d, mul_1, e, f, abs_2, add_1, sqrt, g, h, cos, i, abs_3, neg, exp, j, mean, sub, std, add_4, result], Original ATen: [aten.relu, aten.sigmoid, aten.mul, aten.tanh, aten.gelu, aten.add, aten.abs, aten.sqrt, aten.sin, aten.cos, aten.neg, aten.exp, aten.mean, aten.sub, aten.std, aten.div]
            triton_poi_fused_abs_add_cos_div_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_std_sub_tanh_5_xnumel = s0*s24
            stream0 = get_raw_stream(0)
            triton_poi_fused_abs_add_cos_div_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_std_sub_tanh_5.run(buf9, buf2, buf7, s0, s24, triton_poi_fused_abs_add_cos_div_exp_gelu_mean_mul_neg_relu_sigmoid_sin_sqrt_std_sub_tanh_5_xnumel, stream=stream0)
            del buf2
            del buf7
        return (buf9, )
