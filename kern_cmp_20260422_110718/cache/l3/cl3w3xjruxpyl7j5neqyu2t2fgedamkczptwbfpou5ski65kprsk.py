...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/rd/crdaf7ae3st6wtdeax3n7xx2lpis5ilrcwlepqlwuoqolpfrqmkw.py
# Topologically Sorted Source Nodes: [t1, t2, t3, gelu], Original ATen: [aten.add, aten.mul, aten.gelu]
# Source node to ATen node mapping:
#   gelu => add_2, erf, mul_1, mul_2, mul_3
#   t1 => add
#   t2 => mul
#   t3 => add_1
# Graph fragment:
...
#   %arg3_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg3_1]
#   %add : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg0_1, %arg1_1), kwargs = {})
#   %mul : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %arg2_1), kwargs = {})
#   %add_1 : Tensor "f32[512][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %arg3_1), kwargs = {})
#   %mul_1 : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_1, 0.5), kwargs = {})
#   %mul_2 : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_1, 0.7071067811865476), kwargs = {})
#   %erf : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_2,), kwargs = {})
#   %add_2 : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf, 1), kwargs = {})
#   %mul_3 : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_1, %add_2), kwargs = {})
#   return %mul_3
...
def get_args():
    ...
    return arg_0, arg_1, arg_2, arg_3, arg_4, 512,
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [t1, t2, t3, gelu], Original ATen: [aten.add, aten.mul, aten.gelu]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_gelu_mul_0.run(arg0_1, arg1_1, arg2_1, arg3_1, buf0, 512, stream=stream0)
            del arg0_1
            del arg1_1
            del arg2_1
            del arg3_1
