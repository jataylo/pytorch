...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/4l/c4le6rl72ptwlndg6gpg3juolubjwdwi3wijqjne7vgfhesjowqs.py
...
#   %arg1_1 : Tensor "f32[65536][0]cuda:0" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "f32[65536][1]cuda:0" = PlaceHolder[target=arg2_1]
#   %arg3_1 : Tensor "f32[65536][1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg4_1 : Tensor "f32[65536][1]cuda:0" = PlaceHolder[target=arg4_1]
#   %arg5_1 : Tensor "f32[65536][1]cuda:0" = PlaceHolder[target=arg5_1]
#   %add_2 : Tensor "f32[65536][1]cuda:0" = PlaceHolder[target=add_2]
#   %sub : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg0_1, %arg1_1), kwargs = {})
#   %add : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg2_1, 1e-05), kwargs = {})
#   %sqrt : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%add,), kwargs = {})
#   %div : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sub, %sqrt), kwargs = {})
#   %mul : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %arg3_1), kwargs = {})
#   %add_1 : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %arg4_1), kwargs = {})
#   %relu : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_1,), kwargs = {})
#   %add_2 : Tensor "f32[65536][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%relu, %arg5_1), kwargs = {})
#   %sigmoid : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_2,), kwargs = {})
#   %mul_1 : Tensor "f32[65536][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_2, %sigmoid), kwargs = {})
#   return %add_2,%mul_1
...
def get_args():
    ...
    arg_2 = rand_strided((65536,), (0,), device='cuda:0', dtype=torch.float32)
    arg_3 = rand_strided((65536,), (1,), device='cuda:0', dtype=torch.float32)
    arg_4 = rand_strided((65536,), (1,), device='cuda:0', dtype=torch.float32)
    arg_5 = rand_strided((65536,), (1,), device='cuda:0', dtype=torch.float32)
    arg_6 = rand_strided((65536,), (1,), device='cuda:0', dtype=torch.float32)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, 65536,
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg1_1, (65536, ), (0, ))
        assert_size_stride(arg2_1, (65536, ), (1, ))
        assert_size_stride(arg3_1, (65536, ), (1, ))
        assert_size_stride(arg4_1, (65536, ), (1, ))
        assert_size_stride(arg5_1, (65536, ), (1, ))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            ...
            # Topologically Sorted Source Nodes: [sub, add, sqrt, normalized, mul, scaled, activated, with_residual, output], Original ATen: [aten.sub, aten.add, aten.sqrt, aten.div, aten.mul, aten.relu, aten.silu]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_div_mul_relu_silu_sqrt_sub_0.run(buf1, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, 65536, stream=stream0)
            del arg0_1
            del arg1_1
            del arg2_1
            del arg3_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((65536, ), (0, ), device='cuda:0', dtype=torch.float32)
    ...
    arg4_1 = rand_strided((65536, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg5_1 = rand_strided((65536, ), (1, ), device='cuda:0', dtype=torch.float32)
