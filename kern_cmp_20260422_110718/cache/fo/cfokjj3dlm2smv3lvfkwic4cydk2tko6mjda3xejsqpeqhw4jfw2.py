...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/b6/cb6fjvk75fyoabae4m4m45oc7hxvt4wehwbeelsjkm7zlbd4uu4f.py
# Topologically Sorted Source Nodes: [mul, h1, h1_act, mul_1, h2, residual], Original ATen: [aten.mul, aten.add, aten.gelu]
# Source node to ATen node mapping:
#   h1 => add_4
#   h1_act => add_9, erf, mul_7, mul_8, mul_9
#   h2 => add_18
#   mul => mul
#   mul_1 => mul_13
#   residual => add_23
# Graph fragment:
#   %arg3_1 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg4_1 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0" = PlaceHolder[target=arg4_1]
#   %arg5_1 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0" = PlaceHolder[target=arg5_1]
#   %arg6_1 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0" = PlaceHolder[target=arg6_1]
#   %arg7_1 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0" = PlaceHolder[target=arg7_1]
#   %mul : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg3_1, %arg4_1), kwargs = {})
#   %add_4 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %arg5_1), kwargs = {})
#   %mul_7 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 0.5), kwargs = {})
#   %mul_8 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 0.7071067811865476), kwargs = {})
#   %erf : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_8,), kwargs = {})
#   %add_9 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf, 1), kwargs = {})
#   %mul_9 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %add_9), kwargs = {})
#   %mul_13 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_9, %arg6_1), kwargs = {})
#   %add_18 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_13, %arg7_1), kwargs = {})
#   %add_23 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg3_1, %add_18), kwargs = {})
#   return %add_23
...
def get_args():
    ...
    arg_1 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg_2 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg_3 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg_4 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg_5 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, 262144,
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/4e/c4ejpydxyywdn4cqqobpis3eetxu4uajh5svdpmb5v4ntnxggtj7.py
# Topologically Sorted Source Nodes: [mean, std], Original ATen: [aten.mean, aten.std]
# Source node to ATen node mapping:
#   mean => mean
#   std => var
# Graph fragment:
#   %add_23 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0" = PlaceHolder[target=add_23]
#   %mean : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.default](args = (%add_23,), kwargs = {})
#   %var : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%add_23,), kwargs = {correction: 1.0})
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/bc/cbcswudz5jemfxm3daun5nwl7msan5kc2mg5pnxxbdh6w4m4jiyn.py
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/yc/cycepsg42ubqygckbwxyznw7jnbeauazru6wtzzk6ztrd5nq5phy.py
...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/42/c42ptdawawd7agbrwuh4zvdigapz3tyx273fqkkln7aef43ha66v.py
...
#   %mean : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mean.default](args = (%add_23,), kwargs = {})
#   %sub_18 : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_23, %mean), kwargs = {})
#   %var : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.var.correction](args = (%add_23,), kwargs = {correction: 1.0})
#   %sqrt : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%var,), kwargs = {})
#   %add_32 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sqrt, 1e-06), kwargs = {})
#   %div : Tensor "f32[s23, s12, s20][s12*s20, s20, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sub_18, %add_32), kwargs = {})
#   return %div
...
@triton.jit
def triton_poi_fused_add_div_mean_std_sub_4(in_out_ptr0, in_ptr0, in_ptr1, ks0, ks1, ks2, xnumel, XBLOCK : tl.constexpr):
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = xindex < xnumel
    x0 = xindex
...
class Runner:
    ...
    def call(self, args):
        ...
        s12 = arg3_1_size[1]
        s20 = arg3_1_size[2]
        assert_size_stride(arg3_1, (s23, s12, s20), (s12*s20, s20, 1))
        assert_size_stride(arg4_1, (s23, s12, s20), (s12*s20, s20, 1))
        assert_size_stride(arg5_1, (s23, s12, s20), (s12*s20, s20, 1))
        assert_size_stride(arg6_1, (s23, s12, s20), (s12*s20, s20, 1))
        assert_size_stride(arg7_1, (s23, s12, s20), (s12*s20, s20, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf0 = empty_strided_cuda((s23, s12, s20), (s12*s20, s20, 1), torch.float32)
            # Topologically Sorted Source Nodes: [mul, h1, h1_act, mul_1, h2, residual], Original ATen: [aten.mul, aten.add, aten.gelu]
            triton_poi_fused_add_gelu_mul_0_xnumel = s12*s20*s23
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_gelu_mul_0.run(arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, buf0, triton_poi_fused_add_gelu_mul_0_xnumel, stream=stream0)
            del arg3_1
            del arg4_1
            del arg5_1
            del arg6_1
            ...
            # Topologically Sorted Source Nodes: [mean, std], Original ATen: [aten.mean, aten.std]
            triton_red_fused_mean_std_1_r0_numel = (31 + s12*s20*s23) // 32
            stream0 = get_raw_stream(0)
            triton_red_fused_mean_std_1.run(buf0, buf1, buf3, buf4, buf5, s12, s20, s23, 32, triton_red_fused_mean_std_1_r0_numel, stream=stream0)
            buf2 = empty_strided_cuda((), (), torch.float32)
            # Topologically Sorted Source Nodes: [mean], Original ATen: [aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused_mean_2.run(buf1, buf2, 1, 32, stream=stream0)
            del buf1
            buf7 = empty_strided_cuda((), (), torch.float32)
            # Topologically Sorted Source Nodes: [std], Original ATen: [aten.std]
            stream0 = get_raw_stream(0)
            triton_per_fused_std_3.run(buf3, buf4, buf5, buf7, 1, 32, stream=stream0)
            del buf3
            del buf4
            del buf5
            buf9 = buf0; del buf0  # reuse
            # Topologically Sorted Source Nodes: [mean, sub, std, add_3, normalized], Original ATen: [aten.mean, aten.sub, aten.std, aten.add, aten.div]
            triton_poi_fused_add_div_mean_std_sub_4_xnumel = s12*s20*s23
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_div_mean_std_sub_4.run(buf9, buf2, buf7, s12, s20, s23, triton_poi_fused_add_div_mean_std_sub_4_xnumel, stream=stream0)
            del buf2
            del buf7
        return (buf9, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = 64
    arg2_1 = 64
    arg3_1 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg4_1 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg5_1 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg6_1 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg7_1 = rand_strided((64, 64, 64), (4096, 64, 1), device='cuda:0', dtype=torch.float32)
