...
# kernel path: /dockerx/meta-tuning/pytorch/kern_cmp_20260422_110718/cache/iz/cizaw4fh57v4t7crt4yrwuguuz556zgkv5guxiluonzjx2zxytim.py
...
#   mul => mul_4
#   normalized => div
#   output => mul_9, sigmoid
#   scaled => add_11
#   sqrt => sqrt
#   sub => sub
#   with_residual => add_16
# Graph fragment:
#   %arg1_1 : Tensor "f32[s15][1]cuda:0" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "f32[s15][0]cuda:0" = PlaceHolder[target=arg2_1]
#   %arg3_1 : Tensor "f32[s15][1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg4_1 : Tensor "f32[s15][1]cuda:0" = PlaceHolder[target=arg4_1]
#   %arg5_1 : Tensor "f32[s15][1]cuda:0" = PlaceHolder[target=arg5_1]
#   %arg6_1 : Tensor "f32[s15][1]cuda:0" = PlaceHolder[target=arg6_1]
#   %add_16 : Tensor "f32[s15][1]cuda:0" = PlaceHolder[target=add_16]
#   %sub : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg1_1, %arg2_1), kwargs = {})
#   %add_2 : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg3_1, 1e-05), kwargs = {})
#   %sqrt : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%add_2,), kwargs = {})
#   %div : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sub, %sqrt), kwargs = {})
#   %mul_4 : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %arg4_1), kwargs = {})
#   %add_11 : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_4, %arg5_1), kwargs = {})
#   %relu : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_11,), kwargs = {})
#   %add_16 : Tensor "f32[s15][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%relu, %arg6_1), kwargs = {})
#   %sigmoid : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_16,), kwargs = {})
#   %mul_9 : Tensor "f32[s15][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_16, %sigmoid), kwargs = {})
#   return %add_16,%mul_9
...
def get_args():
    ...
    arg_2 = rand_strided((1048576,), (0,), device='cuda:0', dtype=torch.float32)
    ...
    arg_6 = rand_strided((1048576,), (1,), device='cuda:0', dtype=torch.float32)
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg2_1, (s15, ), (0, ))
        assert_size_stride(arg3_1, (s15, ), (1, ))
        assert_size_stride(arg4_1, (s15, ), (1, ))
        assert_size_stride(arg5_1, (s15, ), (1, ))
        assert_size_stride(arg6_1, (s15, ), (1, ))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            ...
            # Topologically Sorted Source Nodes: [sub, add, sqrt, normalized, mul, scaled, activated, with_residual, output], Original ATen: [aten.sub, aten.add, aten.sqrt, aten.div, aten.mul, aten.relu, aten.silu]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_div_mul_relu_silu_sqrt_sub_0.run(buf1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, s15, stream=stream0)
            del arg1_1
            del arg2_1
            del arg3_1
            del arg4_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((1048576, ), (0, ), device='cuda:0', dtype=torch.float32)
    ...
    arg6_1 = rand_strided((1048576, ), (1, ), device='cuda:0', dtype=torch.float32)
