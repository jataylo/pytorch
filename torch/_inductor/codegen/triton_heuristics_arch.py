...
scoring factors in triton_heuristics_pointwise.py and
triton_heuristics_reduction.py.
"""
...
# Approximate L3 read bandwidth in GB/s (much faster than HBM, slower than L2).
# Used in the three-tier memory time model in triton_heuristics_bottleneck.py.
_L3_BANDWIDTH_GB_S: float = 15_000.0
