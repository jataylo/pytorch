...
# Experimental exhaustive tuner for pointwise/reduction/persistent reduction kernels
experimental_max_autotune = os.environ.get("TORCHINDUCTOR_EXPERIMENTAL_MAX_AUTOTUNE") == "1"
